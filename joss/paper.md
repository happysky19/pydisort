...
Researchers and educators in atmospheric and planetary sciences require radiative-transfer tools that combine:

1. Ease of use (Python interface, minimal build pain).  
2. Performance (native C/Fortran speeds, support for many layers/streams).  
3. Extensibility (GPU acceleration, machine-learning integration).
